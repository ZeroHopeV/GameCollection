...
gdjs.startmenuCode.asyncCallback23873828 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.network.sendAwaitableAsyncRequest("http://10.200.1.163/GameCollection/rrs_gamedatahandler/preset.php", "", "POST", "", runtimeScene.getScene().getVariables().getFromIndex(0), runtimeScene.getScene().getVariables().getFromIndex(1)), (runtimeScene) => (gdjs.startmenuCode.asyncCallback23873828(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.startmenuCode.asyncCallback23875940 = function (runtimeScene, asyncObjectsList) {
}
