...
gdjs.startmenuCode.asyncCallback23875300 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.network.sendAwaitableAsyncRequest("http://10.200.1.163/GameCollection/rrs_gamedatahandler/preset.php", "", "POST", "", runtimeScene.getScene().getVariables().getFromIndex(0), runtimeScene.getScene().getVariables().getFromIndex(1)), (runtimeScene) => (gdjs.startmenuCode.asyncCallback23875300(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.startmenuCode.asyncCallback23877412 = function (runtimeScene, asyncObjectsList) {
}
